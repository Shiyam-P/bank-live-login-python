...
FSDK.ActivateLibrary("HpYQSPxnv1/t3i2MSYJM4jbAF70h1a0BhTmdh+irLaGhKhyIb5g4bqYY7zCZf01IoAqZ+mawfFoncLf7VfxxLn453HuHb38SRTk1yMTMQ2RoAnrXi7ZG01IEWv9Ix6LL+KD6kdVG6JRMuFvaV2yfYp+ntEiCYP8K9bkEKbAaA/s=");
FSDK.Initialize()
...
droidcam_ip = 'http://192.168.1.25:4747/video'
camera = camList[0] # choose the first camera (0)
#camera = droidcam_ip # choose the first camera (0)
...
while 1:
	...
	if win.PeekMessage(win.byref(msg), 0, 0, 0, win.PM_REMOVE):
		...
		if msg.message == win.WM_KEYDOWN and msg.wParam == win.VK_ESCAPE or need_to_exit:
			break
ss = fsdkTracker.GetName(face_id)
outFileName = 'static/upload/' + str(ss) + "Face" + '.jpg'
